...
public:
	...
	bool ReadAutogenDRP(std::optional<uint32_t> val = std::nullopt);
	/// <summary>
	...
	bool ReadEventWindowInput(std::optional<uint32_t> val = std::nullopt);
	/// <summary>
	...
	bool ReadSystemClock(std::optional<uint32_t> val = std::nullopt);
	/// <summary>
	...
	bool ReadTimingEnable(std::optional<uint32_t> val = std::nullopt);
	/// <summary>
	/// Formats the register's current value for register dumps
	/// </summary>
	/// <returns>RegisterFormatter object containing register information</returns>
